    ...
    */
    ...
    public function one($id) {
        ...
        if($cFavorite > 0) {
            ...
            //get photos from barbers photos
            ...
            for($q=0;$q<20;$q++) {
                ...
                if(in_array($weekday, array_keys($availWeekdays))) {
                    ...
                    foreach($availWeekdays[$weekday] as $hoursItem) {
